...
If (CStr(Request("MM_insert")) = "form1") Then
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "INSERT INTO [new] (title, typename, tuijian, picurl, content, Nfrom, zuozhe, selectpic) VALUES (?, ?, ?, ?, ?, ?, ?, ?)" 
...
Recordset1_cmd.CommandText = "SELECT * FROM new" 
        ...
        <div align="center">
          <center>
            <table border="0" cellspacing="1" width="758" bordercolorlight="#000000" bordercolordark="#FFFFFF" cellpadding="0" bgcolor="#000000">
              <tr>
                <td width="100%" height="20" bgcolor="#FFFFFF"><p align="center"><b class="unnamed2 STYLE9">添 加 新 闻</b> </p></td>
              </tr>
              <tr align="center">
                <td width="100%"><table border="0" cellspacing="0" width="100%" cellpadding="0">
                    <tr>
                      ...
                      <td width="83%" height="30" valign="middle" bgcolor="#FFFFFF">
                        <div align="left">
                          <input name="title" type="text" size="60" maxlength="100" style="background-color:ffffff;color:000000;border: 1 double" />
                        </div></td>
                    </tr>
                    <tr>
...
%><option value="<%=(Recordset2.Fields.Item("type").Value)%>" <%If (Not isNull((Recordset1.Fields.Item("typename").Value))) Then If (CStr(Recordset2.Fields.Item("type").Value) = CStr((Recordset1.Fields.Item("typename").Value))) Then Response.Write("selected=""selected""") : Response.Write("")%> ><%=(Recordset2.Fields.Item("type").Value)%></option>
                             <%
  Recordset2.MoveNext()
Wend
...
%>
                    ...
                    <tr>
                      ...
                      <td width="83%" valign="middle" height="5" bgcolor="#FFFFFF"><div align="left">
                          <input <%If (CStr((Recordset1.Fields.Item("tuijian").Value)) = CStr("true")) Then Response.Write("checked=""checked""") : Response.Write("")%> type="checkbox" name="checkbox1" value="1" class="unnamed5" />                      
                      </div></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td width="83%" valign="middle" bgcolor="#FFFFFF"><div align="left">
                          <input name="picurl" type="text" style="background-color:ffffff;color:000000;border: 1 double" value="img/" />
                        </div></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td width="83%" height="30" valign="middle" bgcolor="#FFFFFF"><div align="left">
                          <input name="Nfrom"  type="text" size="30" maxlength="100" style="background-color:ffffff;color:000000;border: 1 double" />
                      </div></td>
                    </tr>
                    <tr>
                      <td width="17%" align="right" height="30" class="unnamed2" valign="middle" bgcolor="#FFFFFF"><div align="left">文章作者：</div></td>
                      <td width="83%" height="30" valign="middle" bgcolor="#FFFFFF"><div align="left">
                        <input name="zuozhe"  type="text" size="30" maxlength="100" style="background-color:ffffff;color:000000;border: 1 double" />
                      </div></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td width="83%" height="30" bgcolor="#FFFFFF" valign="middle"><div align="left">
                          <input <%If (CStr((Recordset1.Fields.Item("selectpic").Value)) = CStr("true")) Then Response.Write("checked=""checked""") : Response.Write("")%> type="checkbox" name="checkbox3" value="1" class="unnamed5" />

...
javastr=javastr+"<font color=\"#0066cc\">◇ </font><span style=\"font-size:9pt;line-height: 13pt\"><a href=\"open.asp?id=<%=rs("newsid")%>&path=<%=rs("path")%>&filename=<%=rs("N_Fname")%>\") target=\"_blank\"><%=rs("title")%></span></a>"

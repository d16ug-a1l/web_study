...
<tr><td height=50>
<a href="index.asp">返回首页</a>&nbsp;&nbsp;<a href="admin_index.asp?action=myuser">用户管理</a>&nbsp;&nbsp;<a href="admin_index.asp?action=tz">帖子管理</a>&nbsp;&nbsp;&nbsp;</td>
</tr></table>
...
<form action="admin_index.asp?action=admin&name=<%=request("name")%>" method="post">
  <table width="96%" border="0"" cellspacing="1" cellpadding="3" align="center"><tr><td><table width="96%" border="0"" cellspacing="1" cellpadding="3" align="center"><tr><td><table width="96%" border="0"" cellspacing="1" cellpadding="3" align="center">
    <tr>
      <td><table width="96%" border="0"" cellspacing="1" cellpadding="3" align="center">
          <tr>
            <td>修改会员密码</td>
          </tr>
          <tr>
            <td>会员名称：<%=request("name")%></td>
          </tr>
          <tr>
            <td>修改密码：
          ...
          <tr>
            <td><input type="submit" name="admin" value="确认"></td>
          </tr>
          <input type="hidden" name="id2" value="<%=request("id")%>">

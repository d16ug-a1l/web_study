...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" >
  <tr> <td></td>
                <td  height=37 align=right valign="bottom" background="images/top.jpg" bgcolor="#6EB7DA" class="bg"><br>
                  <br>
                  <a href="index.asp">论坛首页</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="admin_index.asp">管理登陆</a>
    &nbsp;</td>
  </tr>
</table>
	  ...
	  <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr>
          <FORM action=search2.asp method=post>
	        <td> 快速搜索： 
              <INPUT onMouseOver="this.style.backgroundColor = '#E5F0FF'" title='关键词' style="BORDER-RIGHT: #b4b4b4 1px double; BORDER-TOP: #b4b4b4 1px double; BORDER-LEFT: #b4b4b4 1px double; COLOR: #ff90cd; BORDER-BOTTOM: #b4b4b4 1px double; BACKGROUND-COLOR: #ffffff" onMouseOut="this.style.backgroundColor = ''" name=keyword>
		 <INPUT onMouseOver="this.style.backgroundColor='#64B3D9'" style="BORDER-RIGHT: 0px solid; BORDER-TOP: 0px solid; BORDER-LEFT: 0px solid; COLOR: #000000; BORDER-BOTTOM: 0px solid; BACKGROUND-COLOR: #64B3D9" onMouseOut="this.style.backgroundColor='#64B3D9'" type=submit value=搜索>
	</td>
	</form>
        </tr>
      </table>

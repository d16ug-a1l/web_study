...
If (CStr(Request("MM_update")) = "form1") Then
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "UPDATE shop SET sp_title = ?, sp_pic = ?, sp_leibie = ?, sp_price = ?, sp_pinpai = ?, sp_keyword = ?, sp_shuoming = ? WHERE id = ?" 
...
Recordset1_cmd.CommandText = "SELECT * FROM shop WHERE id = ?" 
          ...
          <form ACTION="<%=MM_editAction%>" METHOD="POST" name="form1">
            <tr>
              ...
              <td width=446 align="right"><div align="left">
                  <input name="title" type="text" value="<%=(Recordset1.Fields.Item("sp_title").Value)%>" size="30">
              </div></td>
            </tr>
            <tr>
              <td height="29" align="right" class="STYLE2"><div align="center"><span class="greenb">商品图片</span></div></td>
              <td align="right"><div align="left">
                  <input name="picture" type="text" value="<%=(Recordset1.Fields.Item("sp_pic").Value)%>">
              </div></td>
            </tr>
                        <tr>
...
%><option value="<%=(Recordset2.Fields.Item("fenlei").Value)%>" <%If (Not isNull((Recordset2.Fields.Item("fenlei").Value))) Then If (CStr(Recordset2.Fields.Item("fenlei").Value) = CStr((Recordset2.Fields.Item("fenlei").Value))) Then Response.Write("selected=""selected""") : Response.Write("")%> ><%=(Recordset2.Fields.Item("fenlei").Value)%></option>
                    <%
  Recordset2.MoveNext()
Wend
...
%>
            ...
            <tr>
              ...
              <td align="right"><div align="left">
                  <input name="price" type="text" value="<%=(Recordset1.Fields.Item("sp_price").Value)%>">
              </div></td>
            </tr>
                        <tr>
              <td height="27" align="right" class="STYLE2"><div align="center"><span class="greenb">商品</span>品牌</div></td>
              <td align="right"><div align="left">
                  <input name="pinpai" type="text" value="<%=(Recordset1.Fields.Item("sp_pinpai").Value)%>">
              </div></td>
            </tr>
             <tr>
              <td height="27" align="right" class="STYLE2"><div align="center">关键字</div></td>
              <td align="right"><div align="left">
                  <input name="keyword" type="text" value="<%=(Recordset1.Fields.Item("sp_keyword").Value)%>">
              </div></td>
            </tr>
            <tr>
              <td height="47" align="right" class="STYLE2"><div align="center">商品简介 </div></td>
              <td align="right"><div align="left">
                  <textarea name="abtract" cols="50" rows="8"><%=(Recordset1.Fields.Item("sp_shuoming").Value)%></textarea>
              </div></td>
            </tr>
            <tr>

...
%>
          ...
          <% If Not Recordset1.EOF Or Not Recordset1.BOF Then %>
            <table width="782" align="center" cellpadding="0" cellspacing="1"bordercolor="#99BB99" bgcolor="#0000FF" style=" border-collapse: collapse">
              <tr>
                <td width=158 align="right" bgcolor="#FFFFFF"><p align="center"  class="greenb">商品名称</td>
                  <td width="158" bgcolor="#FFFFFF" ><div align="center"><span class="greenb">商品</span><span class="greenb">价格</span></div></td>
                  <td width="227" bgcolor="#FFFFFF" ><div align="center">商品简介</div></td>
                  <td width="154" bgcolor="#FFFFFF" >商品品牌</td>
                  <td width="39" align="center" bgcolor="#FFFFFF" >删除</td>
                  <td width="37" bgcolor="#FFFFFF" >修改</td>
              </tr>
              <% 
...
%>
                <tr>
                  ...
                  <td align="center" bgcolor="#FFFFFF"><a href="delshop.asp?id=<%=(Recordset1.Fields.Item("id").Value)%>">删除</a></td>
                  <td align="center" bgcolor="#FFFFFF"><a href="updateshop.asp?id=<%=(Recordset1.Fields.Item("id").Value)%>">修改</a></td>
                </tr>
                <% 

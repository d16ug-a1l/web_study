              ...
              <tr>
                <td width="668" align="left" valign="middle"><table width="607" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td colspan="3"><p>&nbsp;</p>
                      <p>
                        <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="300" height="33">
                          <param name="movie" value="text12.swf">
                          <param name="quality" value="high">
                          <embed src="text12.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="300" height="33" ></embed>
                        </object>
                      </p></td>
                  </tr>
                </table>

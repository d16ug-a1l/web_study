...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" >
  <tr> <td></td>
                <td  height=37 align=right valign="bottom" background="images/top.jpg" bgcolor="#6EB7DA" class="bg"><br>
                  <br>
                  <a href="index.asp">论坛首页</a>&nbsp;&nbsp;<a href="index.asp?show=jinghua" target=_blank>精 华 区</a>&nbsp;&nbsp;<a href="admin_index.asp">管理登陆</a>
    &nbsp;</td>
  </tr>
</table>
<br />
  ...
  <tr>
    <td>
      <table cellpadding=0 cellspacing=0 border=0 width=98% align=center>
        <tr>
	<td width="98" valign="center" height=40><a href="writenew.asp"><img src="images/postnew.gif" width="72" height="21" border="0"></a></td>
...
<td bgcolor="#DAEDF5" align="center" valign="top" width="20%"> 
          ...
          <td width="80%" align="right" valign="top" bgcolor="#FFFFFF"> 
            ...
            <p><a href="delreplay.asp?id=<%=(Recordset2.Fields.Item("re_id").Value)%>">删除</a></p></td>
        </tr>
        <tr>
          <td bgcolor="#92C8E2" align="center" valign="top" width="20%">&nbsp;</td>
